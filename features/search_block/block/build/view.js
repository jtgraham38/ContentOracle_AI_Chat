...
function updateNoticePosition(searchbarEl) {
  ...
  (0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_0__.computePosition)(searchbarEl, noticeEl, {
    placement: "bottom",
    middleware: [(0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_0__.flip)(),
    //flip if against a border
