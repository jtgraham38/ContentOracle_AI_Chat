...
////
//////
//////// UTILITY FUNCTIONS derived from core/search block.  See it's rendering here: https://github.com/WordPress/gutenberg/blob/trunk/packages/block-library/src/search/index.php
//////
////
//

//CHANGES I MADE TO THE BELOW FUNCTIONS:
// 1. I removed the is_button_inside check because I am not yet supporting that attribute


/**
 * Server-side rendering of the `contentoracle/ai-search` block.
 * ATTENTION: derived from core/search block.  See it here: https://github.com/WordPress/gutenberg/blob/trunk/packages/block-library/src/search/index.php
 * @package WordPress
 */


/**
 * Builds the correct top level classnames for the 'contentoracle/ai-search' block.
 *
 * @since 5.6.0
 *
...
function apply_block_contentoracle_ai_search_border_style( $attributes, $property, $side, &$wrapper_styles, &$button_styles, &$input_styles ) {
	...
	if ( true/*$is_button_inside*/ ) {
        //NOTE: I commented the is_button_inside check because I am not yet supporting that attribute
...
function get_typography_styles_for_block_contentoracle_ai_search( $attributes ) {
	...
	if ( ! empty( $attributes['style']['typography']['fontSize'] ) ) {
         ...
         */
        function get_border_color_classes_for_block_contentoracle_ai_search( $attributes ) {
...
//I don't need the below, since I will render the block myself.  Keeping it here for reference.
// /**
//  * Dynamically renders the `contentoracle/ai-search` block.
//  *
...
//  */
// function render_block_contentoracle_ai_search( $attributes ) {
...
// 		);
// 		$form_directives      = '
// 		 data-wp-interactive="contentoracle/ai-search"'
// 		. $form_context .
...
// /**
//  * Registers the `contentoracle/ai-search` block on the server.
//  *
//  * @since 5.2.0
//  */
// function register_block_contentoracle_ai_search() {
// 	register_block_type_from_metadata(
// 		__DIR__,
// 		array(
// 			'render_callback' => 'render_block_contentoracle_ai_search',
// 		)
// 	);
// 	var_dump(__DIR__);
// 	die;
// }
// add_action( 'init', 'register_block_contentoracle_ai_search' );