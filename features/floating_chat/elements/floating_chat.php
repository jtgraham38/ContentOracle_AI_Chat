...
if (is_active_sidebar($widget_area_id)) {
    ...
    <button id="coai_floating_chat_toggle" class="floating-chat-toggle" onclick="toggleFloatingChat()">
        <span class="chat-icon">💬</span>
    </button>
    
    <!-- Floating Chat Container (initially hidden) -->
    <div id="coai_chat_floating_chat_container" class="floating-chat-container" style="display: none;">
        <div class="floating-chat-header">
            <h3>AI Chat</h3>
            <button class="close-chat-btn" onclick="toggleFloatingChat()">×</button>
        </div>
