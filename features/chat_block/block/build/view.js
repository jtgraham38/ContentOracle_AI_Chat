...
class FeaturedContentArtifact extends _artifact__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  render(content_supplied, featured_content_border_classes, featured_content_button_classes) {
    ...
    featured_content_border_classes.map(border_class => {
      if (border_class) container.classList.add(border_class);
    });
    ...
    featured_content_button_classes.map(button_class => {
      if (button_class) btn.classList.add(button_class);
    });
...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].data('contentoracle_ai_chat', () => ({
  ...
  init() {
    ...
    if (this.scrollBlockIntoView) this.scrollToBlock();
  },
