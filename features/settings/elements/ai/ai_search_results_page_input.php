...
<div>
    <select
        name="<?php echo esc_attr( $this->get_prefix() . 'ai_results_page' ) ?>" 
        class="<?php echo esc_attr( $this->get_prefix() . 'ai_results_page' ) ?>" 
        id="<?php echo esc_attr( $this->get_prefix() . 'ai_results_page_input' ) ?>" 
